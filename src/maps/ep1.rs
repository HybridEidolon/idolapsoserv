...
impl Ep1Areas {
    ...
    pub fn load_from_files_offline(path: &str) -> io::Result<Ep1Areas> {
        let city = try!(VariationData::load_from_files(path,
            "map_city00_00e_s.dat", "map_city00_00o_s.dat"));

        let forest1 = {
            let mut vs = Vec::with_capacity(3);
            vs.push(try!(VariationData::load_from_files(path,
                "map_forest01_00_offe.dat", "map_forest01_00o.dat")));
            vs.push(try!(VariationData::load_from_files(path,
                "map_forest01_02_offe.dat", "map_forest01_02o.dat")));
            vs.push(try!(VariationData::load_from_files(path,
                "map_forest01_04_offe.dat", "map_forest01_04o.dat")));
            vs
        };
        let forest2 = {
            let mut vs = Vec::with_capacity(3);
            vs.push(try!(VariationData::load_from_files(path,
                "map_forest02_00_offe.dat", "map_forest02_00o.dat")));
            vs.push(try!(VariationData::load_from_files(path,
                "map_forest02_03_offe.dat", "map_forest02_03o.dat")));
            vs.push(try!(VariationData::load_from_files(path,
                "map_forest02_04_offe.dat", "map_forest02_04o.dat")));
            vs
        };
        let cave1 = {
            let mut vs = HashMap::with_capacity(3);
            vs.insert((0, 0), try!(VariationData::load_from_files(path,
                "map_cave01_00_00_offe.dat", "map_cave01_00_00o.dat")));
            vs.insert((1, 0), try!(VariationData::load_from_files(path,
                "map_cave01_01_00_offe.dat", "map_cave01_01_00o.dat")));
            vs.insert((2, 0), try!(VariationData::load_from_files(path,
                "map_cave01_02_00_offe.dat", "map_cave01_02_00o.dat")));
            vs
        };
        let cave2 = {
            let mut vs = HashMap::with_capacity(3);
            vs.insert((0, 0), try!(VariationData::load_from_files(path,
                "map_cave02_00_00_offe.dat", "map_cave02_00_00o.dat")));
            vs.insert((1, 0), try!(VariationData::load_from_files(path,
                "map_cave02_01_00_offe.dat", "map_cave02_01_00o.dat")));
            vs.insert((2, 0), try!(VariationData::load_from_files(path,
                "map_cave02_02_00_offe.dat", "map_cave02_02_00o.dat")));
            vs
        };
        let cave3 = {
            let mut vs = HashMap::with_capacity(3);
            vs.insert((0, 0), try!(VariationData::load_from_files(path,
                "map_cave03_00_00_offe.dat", "map_cave03_00_00o.dat")));
            vs.insert((1, 0), try!(VariationData::load_from_files(path,
                "map_cave03_01_00_offe.dat", "map_cave03_01_00o.dat")));
            vs.insert((2, 0), try!(VariationData::load_from_files(path,
                "map_cave03_02_00_offe.dat", "map_cave03_02_00o.dat")));
            vs
        };
        let machine1 = {
            let mut vs = HashMap::with_capacity(6);
        ...
        let boss3 = try!(VariationData::load_from_files(path,
            "map_boss03e.dat", "map_boss03o.dat"));
        let boss4 = try!(VariationData::load_from_files(path,
            "map_boss04e.dat", "map_boss04_offo.dat"));
